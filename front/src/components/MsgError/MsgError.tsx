...
export default function MsgError({ msg, duration = 5000 }: MsgErrorProps) {
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center gap-4 bg-red-500 p-5 rounded-lg shadow-xl">
                <div className="flex items-center gap-4">
                    <FaExclamationTriangle className="lg:text-3xl text-white" />
